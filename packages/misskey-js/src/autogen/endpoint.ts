...
export type Endpoints = {
	...
	'admin/emoji/get-emoji-log': { req: AdminEmojiGetEmojiLogRequest; res: AdminEmojiGetEmojiLogResponse };
	...
	'i/registry/remove-all-keys-in-scope': { req: IRegistryRemoveAllKeysInScopeRequest; res: EmptyResponse };
	...
	'notes/relational-timeline': { req: NotesRelationalTimelineRequest; res: NotesRelationalTimelineResponse };
...
export const endpointReqTypes: Record<keyof Endpoints, 'application/json' | 'multipart/form-data'> = {
	...
	'admin/emoji/get-emoji-log': 'application/json',
	...
	'i/registry/remove-all-keys-in-scope': 'application/json',
	...
	'notes/relational-timeline': 'application/json',
	...
	'roles/add': 'application/json',
	'roles/assign': 'application/json',
	'roles/unassign': 'application/json',
	'roles/update': 'application/json',
