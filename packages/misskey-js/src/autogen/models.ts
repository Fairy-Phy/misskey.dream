...
export type EmojiChangeInfo = components['schemas']['EmojiChangeInfo'];
export type EmojiChangesProperty = components['schemas']['EmojiChangesProperty'];
export type EmojiChangeLog = components['schemas']['EmojiChangeLog'];
export type EmojiChangeLogs = components['schemas']['EmojiChangeLogs'];
