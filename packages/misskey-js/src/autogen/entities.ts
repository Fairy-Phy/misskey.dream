...
export type AdminEmojiGetEmojiLogRequest = operations['admin___emoji___get-emoji-log']['requestBody']['content']['application/json'];
export type AdminEmojiGetEmojiLogResponse = operations['admin___emoji___get-emoji-log']['responses']['200']['content']['application/json'];
export type AdminEmojiGetEmojiLogsRequest = operations['admin___emoji___get-emoji-logs']['requestBody']['content']['application/json'];
export type AdminEmojiGetEmojiLogsResponse = operations['admin___emoji___get-emoji-logs']['responses']['200']['content']['application/json'];
...
export type IRegistryRemoveAllKeysInScopeRequest = operations['i___registry___remove-all-keys-in-scope']['requestBody']['content']['application/json'];
...
export type NotesRelationalTimelineRequest = operations['notes___relational-timeline']['requestBody']['content']['application/json'];
export type NotesRelationalTimelineResponse = operations['notes___relational-timeline']['responses']['200']['content']['application/json'];
