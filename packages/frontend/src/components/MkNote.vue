		...
		<div :class="$style.main">
			...
			<footer :class="$style.footer">
				...
				<button v-if="appearNote.myReaction == null" ref="reactButton" :class="$style.footerButton" class="_button" @mousedown="react()">
					...
					<p v-if="reactionCount > 0" :class="$style.footerButtonCount">{{ reactionCount }}</p>
				</button>
...
let reactionCount = computed(() => Object.values(appearNote.value.reactions).reduce((p, v) => p + v, 0));
...
const canRenote = computed(() => ['public', 'home', 'relational'].includes(appearNote.value.visibility) || (appearNote.value.visibility === 'followers' && appearNote.value.userId === $i.id));
