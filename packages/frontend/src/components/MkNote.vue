...
let reactionCount = $computed(() => Object.values(appearNote.reactions).reduce((p, v) => p + v, 0));
...
const canRenote = computed(() => ['public', 'home', 'relational'].includes(appearNote.visibility) || (appearNote.visibility === 'followers' && appearNote.userId === $i.id));
