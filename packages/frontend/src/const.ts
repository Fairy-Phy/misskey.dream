...
export const MFM_TAGS = ['tada', 'jelly', 'twitch', 'shake', 'spin', 'jump', 'bounce', 'flip', 'x2', 'x3', 'x4', 'scale', 'position', 'fg', 'bg', 'border', 'font', 'blur', 'rainbow', 'sparkle', 'rotate', 'ruby', 'unixtime', 'fgg', 'bgg', 'clip', 'move', 'mix', 'skew'];
export const MFM_PARAMS: Record<typeof MFM_TAGS[number], string[]> = {
	...
	bgg: ['colorN=', 'stepN='],
	clip: ['t=', 'b=', 'l=', 'r=', 'circle'],
	move: ['fromx=', 'fromy=', 'tox=', 'toy=', 'speed=', 'delay=', 'rev', 'once', 'ease', 'easein', 'easeout', 'easeinout'],
	mix: [],
	skew: ['x=', 'y='],
};
