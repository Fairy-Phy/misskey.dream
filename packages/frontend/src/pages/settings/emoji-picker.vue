...
const emojiPickerDisplaySensitiveEmoji = computed(defaultStore.makeGetterSetter('displaySensitiveEmoji'));
const emojiPickerSearchLimit = computed(defaultStore.makeGetterSetter('emojiSearchLimit'));
