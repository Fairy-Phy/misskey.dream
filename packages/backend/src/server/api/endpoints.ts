...
const eps = [
	...
	['admin/emoji/get-emoji-logs', ep___admin_emoji_getEmojiLogs],
	['admin/emoji/enable-selfmade-bulk', ep___admin_emoji_enableSelfmadeBulk],
	...
	['notes/relational-timeline', ep___notes_relationalTimeline],
